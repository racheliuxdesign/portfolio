      ...
      <div className="w-full max-w-[1180px] px-[28px] py-[26px]">
        ...
        <div className="flex items-end justify-between mb-[20px]">
          <div>
            ...
            <p style={{ fontFamily: F.medium, fontSize: 13, color: "#64748b", marginTop: 3 }}>Security Operations Center</p>
          </div>
...
function TopNav({ tab, onTab }: { tab: TopTab; onTab: (t: TopTab) => void }) {
  const tabs: { id: TopTab; label: string }[] = [
    ...
    { id: "presentation", label: "Design Specification brief" },
  ];
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
        ...
        <span style={{ fontFamily: F.bold, fontSize: 16, color: "#fff", letterSpacing: "-0.2px" }}>Compromised Identity Mockup, Final Design</span>
      </div>
