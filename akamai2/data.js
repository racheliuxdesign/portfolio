...
const MOCK = {
    ...
    attackPath: {
        ...
        nodes: [
            ...
            },
            {
                id: "device",
                icon: "monitor-x",
                label: "DESKTOP-7F3K2L9",
                sub: "Unmanaged endpoint",
                tone: "high",
                pivot: "device",
                tag: "Trust 8"
            },
    ...
    files: [
        {
            name: "Payment_Card_Records_2024.db",
            type: "db",
            size: "12.1 GB",
            class: "restricted",
            records: "912K records"
        },
        ...
        {
            name: "Banking_Details_Export.csv",
            type: "csv",
            size: "5.4 GB",
            class: "confidential",
        ...
        {
            name: "Salary_Compensation_Data.xlsx",
            type: "xlsx",
            size: "1.1 GB",
            class: "restricted",
            records: "2,140 records"
        },
    ...
    timeline: [
        {
            time: "02:01:14",
            tone: "info",
            title: "New device authenticated via SSO",
            detail: "MFA push approved from DESKTOP-7F3K2L9"
        },
        {
            time: "02:01:52",
            tone: "warn",
            title: "Device fingerprint unrecognized",
            detail: "Trust score 8/100 · unmanaged host flagged"
        },
        {
            time: "02:03:07",
            tone: "warn",
            title: "Bulk download initiated",
            detail: "Cloud Drive · Finance › Customer Data folder"
        },
        {
            time: "02:03–02:47",
            tone: "critical",
            title: "50 GB transferred across 11 files",
            detail: "Sustained 19 MB/s outbound to residential IP"
        },
        {time: "02:47:41", tone: "warn", title: "Download completed", detail: "All 11 files fully transferred"},
        {
            time: "02:48:03",
            tone: "critical",
            title: "AI Behavioral Engine detected exfiltration",
            detail: "Pattern match: MITRE T1567 · confidence 96%"
        },
        {
            time: "02:48:05",
            tone: "critical",
            title: "Alert ALT-2026-0714 created",
            detail: "Risk score 95/100 · routed to SOC queue"
        },
    ],
